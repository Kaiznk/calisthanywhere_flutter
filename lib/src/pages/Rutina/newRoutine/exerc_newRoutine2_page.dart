...
class ExercNewRoutine2 extends StatefulWidget {
  @override
  _ExercNewRoutineState2 createState() => _ExercNewRoutineState2();
}

class _ExercNewRoutineState2 extends State<ExercNewRoutine2> {
  ...
  Widget build(BuildContext context) {
    ...
    iterador = _dataNewRout.iteradorEjer;
    return Scaffold(
      appBar: AppBar(
